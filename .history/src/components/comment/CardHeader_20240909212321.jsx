...
// 卡片的头部组件
const CardHeader = ({ avatarUrl, name, sex, time, content,display }) => {
  const [visible, setVisible] = useState(false);
  return (
    <div className="text-center flex items-center no-select">
      <Avatar className="w-[20px] h-[20px] mr-1 rounded-full" src={display?avatarUrl:"https://img.qiqi.pro/x/anonymous-avatar.jpg"} />
      {display?"匿名":name}&nbsp; <SexIcon sex={sex} />
      <div
