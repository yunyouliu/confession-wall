...
import { Button, Image, SearchBar,Toast } from "antd-mobile";
  ...
  return (
    <div>
      ...
      <div className="bg-[#fde5e9] mr-0.5 mt-4 ml-2 rounded-md h-[30px] text-center flex leading-9 ">
        ...
        />
        买电脑 别去什么安哲之类的公司，价格高于市场...{" "}
        <RightOutline className="mt-3 ml-1" />
      </div>
    </div>
  );
};
