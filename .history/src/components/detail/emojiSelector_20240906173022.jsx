  ...
  return (
    <div className=" p-2 bg-[#fde5e9]  shadow-md  ">
      ...
      <div className="flex flex-row  mt-4">
        ...
        <SvgIcon iconName="bianji" className="mt-[12px] ml-1" />
        <div className="ml-auto h-2">
          <Checkbox checked={checked} onClick={() => setchecked(!checked)} className="mt-2">
           <span className="text-sm text-gray-500 ml-[-4px]"> {checked ? "已匿名" : "可匿名"}</span>
          </Checkbox>
          <Button color="success" className="rounded-3xl h-8 ml-2 mt-[-29px]">
            评论
          </Button>
        </div>
      </div>
