...
const EmojiSelector = ({ sex, name, avatarUrl }) => {
  ...
  return (
    <div className="p-2 bg-[#fde5e9] shadow-md relative">
      ...
      {/* 表情选择框 */}
      {isDropdownOpen && (
        <div className="absolute   left-1/2 transform -translate-x-1/2 mt-4 w-80 p-2 bg-white rounded shadow-lg">
          <div className="grid grid-cols-8 gap-2 h-50 overflow-auto">
