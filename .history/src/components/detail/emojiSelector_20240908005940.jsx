    ...
    <div className="p-2 bg-[#fde5e9] shadow-md relative">
      ...
      >
        <div className=" items-center text-center">
          <List>
            <List.Item className="">拍摄</List.Item>
            <List.Item className="">从相册选择</List.Item>
          </List>
          <span className="h-2 bg-black w-full"></span>
          <Button className="w-full mt-2" onClick={() => setVisible(false)}>取消</Button>
        </div>
      </Popup>
