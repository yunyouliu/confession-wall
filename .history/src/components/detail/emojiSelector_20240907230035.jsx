...
import { TextArea, Checkbox, Button,useRef} from "antd-mobile";
...
const EmojiSelector = ({ sex, name, avatarUrl }) => {
  ...
  return (
    <div className="p-2 bg-[#fde5e9] shadow-md relative">
      ...
      {/* 表情选择框 */}
      {isDropdownOpen && (
        <div className="absolute  z-50 left-1/2 transform -translate-x-1/2 mx-2  w-full p-2 bg-white rounded shadow-lg">
