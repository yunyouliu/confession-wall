    ...
    <div className="p-2 bg-[#fde5e9] shadow-md relative">
      ...
      >
        <div className=" items-center text-center">
          <List>
            <List.Item className="h-9 text-center">拍摄</List.Item>
            <List.Item className="h-9">从相册选择</List.Item>
          </List>
          <Button className="w-full h-110" onClick={() => setVisible(false)}>取消</Button>
        </div>
      </Popup>
