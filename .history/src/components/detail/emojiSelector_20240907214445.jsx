...
import { TextArea, Checkbox, Button, Popup } from "antd-mobile";
...
const EmojiSelector = ({ sex, name, avatarUrl }) => {
  ...
  return (
    <div className="p-2 bg-[#fde5e9] shadow-md ">
      ...
      <CustomDropdown dropdownContent={ <div className="grid grid-cols-8 mt-2 w-29 p-2 ml-4 h-40 overflow-auto bg-white">
      ...
      {/* <Popup
        ...
        mask={false} // 关闭遮罩
      >
        <div className="grid grid-cols-8 mt-2 w-29 p-2 ml-4 h-40 overflow-auto bg-white">
          {jsonData.map((emoji, index) => (
            <img
              className="w-5 h-5 mr-2 mb-2"
              src={emoji.url}
