  ...
  return (
    <div className=" p-2 bg-[#fde5e9]  shadow-md  ">
      ...
      <div className="flex  mt-4">
        ...
        <div className="text-xs ml-auto flex">
          <Checkbox checked={checked} onClick={() => setchecked(!checked)} >{checked?'已匿名':'可匿名'}</Checkbox>
          <Button color="success" className="rounded-3xl h-9 ">评论</Button>
        </div>
      </div>
      {/*  */}
    </div>
