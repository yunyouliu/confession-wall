...
const Footer = () => {
  ...
  return (
    <div>
      <Button
        className="fixed bottom-16 w-80 left-1/2 transform -translate-x-1/2 h-9  z-10"
        onClick={() => {
          navigate("/"); // 点击按钮时导航到主页
        }}
      >
      ...
      <div className=" left-0 right-0 p-4 bg-white text-center text-xs text-gray-500 z-10 h-4">
        本服务由口袋青年提供
      </div>
    </div>
  );
