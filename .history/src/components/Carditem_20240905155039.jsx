  ...
  return (
    <div className="mt-3 ml-2">
      <Card className="bg-purple-300" onClick={() => {}}>
        ...
        <div id="footer" className="flex-1">
          <div>
            <svg className="icon float-left" aria-hidden="true">
              <use xlinkHref="#icon-dianzan"></use>
            </svg>
            <svg className="icon float-right" aria-hidden="true">
              <use xlinkHref="#icon-dianzan"></use>1
            </svg>
          </div>
        </div>
      </Card>
