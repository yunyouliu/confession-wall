  ...
  return (
    <div className="flex justify-between mt-2">
      ...
      <div className="flex items-center">
        <SvgIcon iconName={isLiked ? "dianzan1" : "dianzan"} className="icon" onClick={handleLikeClick} />
        <span className="">{isLiked ? likes + 1 : likes}</span>
        <SvgIcon iconName="guankan" className="icon ml-3"onselectstart="return false;" />
        <span>{views}</span>
      </div>
