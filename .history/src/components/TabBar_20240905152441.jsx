...
const TabBar = () => {
  ...
  const [activKey, setactivKey] = useState(2);
  return (
    <>
          ...
          {tab.map((item) => {
            return (
              <Grid.Item key={item.key}>
                ...
                className={`${activKey==item.key?"bg-emerald-200 text-emerald-500":"bg-slate-200"} h-[45px] m-0 leading-[50px] text-sm rounded-md`}
                >
