...
const Detail = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-200 via-purple-200 h-screen ">
      <span className="text-xs text-gray-500 float-right mt-[-20px]  leading-none scale-2">
        点击右上角分享给好友↑
      </span>
      <div className="pr-1 mt-6 bg-gradient-to-r from-pink-200 via-purple-200">
        {/* 卡片内容 */}
        <CardItem
          userId={Data.id}
          key={Data}
