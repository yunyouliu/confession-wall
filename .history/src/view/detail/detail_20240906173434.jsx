  ...
  return (
    <div className="bg-gradient-to-r from-pink-200 via-purple-200 h-full p-2">
      ...
      <div className="pr-1 mt-4">
        ...
        {/* 添加评论输入框 */}
        <div className="mt-4">
          <EmojiSelector sex={Data.sex} name={Data.name} avatarUrl={Data.avatarUrl} />
        </div>
        <div className="mt-4">
         <a href="https://mp.weixin.qq.com/s/MSKzIREICBiI43_bwkDg_g"> <img src="https://img.qiqi.pro/x/clmqfna8t24eeuhuzk6ikf3kf.jpg?_s=1283x558"/></a>
        </div>
        {/* 评论列表 */}
