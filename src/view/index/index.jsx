...
const Index = () => {
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      if (newData.length < 10) {
        ...
        Toast.show({ content: "暂无更多数据了", position: "bottom" });
      }
      ...
      Toast.show({ content: "加载失败：" + error.message, position: "bottom" });
    } finally {
  ...
  return (
    <div className="p-2 bg-gradient-to-r from-pink-200 via-purple-200">
      <NavBar />
      <TabBar />
